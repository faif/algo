...
let start = "Los Angeles", destination = "New York"
print("== Shortest path from \(start) to \(destination) ==")
let path = pathDictToPath(from: cityGraph2.indexOfVertex(start)!, to: cityGraph2.indexOfVertex(destination)!, pathDict: pathDict)
